...
* The original package name 'com.enterprise.expense-management' is invalid and this project uses 'com.enterprise.expensemanagement' instead.
...
```
$ docker run --rm -p 8080:8080 expense-management:0.0.1-SNAPSHOT
```
